"""
MQTT -> KUKSA VSS feeder for HPC-2 / ZCU-2.
...
VSS_TOPIC_MAP = {
    "zcu2/sensor/temperature": "Vehicle.SDVReplica.ZCU2.Temperature",
}
...
def on_connect(client, userdata, flags, rc):
    if rc != 0:
        ...
        return
    log.info("connected to broker, subscribing to zcu2/#")
    client.subscribe("zcu2/#")
